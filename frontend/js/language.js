let ru = {
    ...
    "profile_about_text2":
        "<br><br>Идею придумала моя дочка Варя, которая к 8 годама собрала удивительный пакет качеств: она любила делиться и читать. <br><br>" +
        "Оба этих качества, смело думаю, выросли не без моей помощи, и горжусь неимоверно.<br><br>" +
        "Итак, в чём идея Бубука: <br><br>" +
        "- Варя регистрируется в системе, заходит в свой кабинет, добавляет данные про книги, которые уже прочитала <br><br>" +
        ...
        "- Кира заходит на страницу Вари, видит все её книги и обнаруживает, что книга \"Гарри Поттер возвращается\" - как раз та, что она давно хотела прочитать. <br><br>" +
        "\"Да,\" - пишет Кира, - \"давай меняться!\" <br><br>" +
        "- После этого девочки обмениваются книгами либо почтой, либо при личной встрече, и мир улучшается.<br><br>"
...
let ua = {
    ...
    "log_out_title": "Вийти",
    "profile_about_title": "Про бубук",
    "profile_about_text1": "Бубук було створено задля того, аби люди, що читають, зустрічалися.<br><br>",
    "profile_about_text2": ""
}
...
let en = {
    ...
    "profile_about_text2": "<br><br>Boobook was created to help reading people meet each other."
}
