let ru = {
    ...
    "menu_find_title": "Найти",
    "menu_books_title": "Найти книгу",
    "menu_readers_title": "Найти читателя",
    "menu_favorite_readers_title": "Друзья",
    "favorite_readers_title": "Друзья",
    "logo_title": "Бубук",
    "add_reader_to_favorites_title": "Добавить в друзья",
    "remove_reader_from_favorites_title": "Удалить из друзей",
    ...
    "select_age_midschool_title": "средняя школа",
    "select_age_adult_title": "взрослые",

    "description_title": "Что вам понравилось",
    "images_description_title": "Хорошо добавить обложку, страницу с текстом и страницу с иллюстрацией.",
    ...
    "edit_book_select_age_midschool_title": "средняя школа",
    "edit_book_select_age_adult_title": "взрослые",

    "edit_book_description_title": "Что вам понравилось",
    "edit_book_images_description_title": "Хорошо добавить обложку, страницу с текстом и страницу с иллюстрацией.",
    ...
    "profile_update_button_title": "Сохранить",
    ...
    "updatingImageProblem_title": "Фотографии нельзя изменить из-за ошибки сервера. Максимальный размер всех 5 файлов - 100 Мб.",
    ...
    "details_description_title": "Что понравилось: ",
    "details_owner_title": "Читатель: ",
    ...
    "search_book_age_from_title": "От возраста",
    "search_book_age_to_title": "До возраста",
    ...
    "change_language_close_title": "Закрыть",
    "log_out_title": "Выйти",
    "profile_about_title": "Про бубук",
    "profile_about_text1": "1. Люди, которые читают книги, дружат <br>" +
        "2. Книги, которые читают люди, не лежат на полках <br>" +
        "3. Мир становится чуточку добрее <br><br>",
    "profile_about_text2":
        "<br><br>Идею придумала моя дочка Варя, которая к 8 годам собрала удивительный комплект: она любила делиться" +
        " и читать. <br><br>" +
        "Смело думаю, что оба качества выросли с моей помощью, и горжусь неимоверно.<br><br>" +
        "Итак, в чём идея Бубука:<br><br>" +
        "* Варя регистрируется в системе, заходит в свой кабинет и добавляет данные про книги, которые у неё" +
        " прочитанные стоят на полке.<br><br>" +
        "* Кира регистрируется в системе, заходит в свой кабинет и добавляет данные про книги, которые у неё" +
        " прочитанные стоят на полке.<br><br>" +
        "* Варя ищет книгу, которую хочет прочитать, и - о, чудо! - находит её среди книг Киры.<br><br>" +
        "* Варя пишет Кире: <br>" +
        "Привет! Меня заинтересовала твоя книга \"Старик Хоттабыч в гостях у Чебурашки\", посмотри" +
        " пожалуйста, может, тебе интересна какая-то из моих книг?<br><br>" +
        "* Кира заходит на страницу Вари, видит все её книги и обнаруживает, что книга \"Гарри Коттик и философский" +
        " камень\" - как раз та, которую она давно хотела прочитать. <br><br>" +
        "* Да, - пишет Кира, - давай меняться!<br><br>" +
        "* После этого девочки обмениваются книгами - либо почтой, либо при личной встрече - и мир" +
        " улучшается.<br><br>"
...
let ua = {
    ...
    "menu_books_title": "Знайти книгу",
    "menu_readers_title": "Знайти читача",
    "menu_favorite_readers_title": "Друзі",
    "favorite_readers_title": "Друзі",
    "logo_title": "Бубук",
    "add_reader_to_favorites_title": "Додати до друзів",
    "remove_reader_from_favorites_title": "Прибрати з друзів",
    ...
    "select_age_midschool_title": "середня школа",
    "select_age_adult_title": "дорослі",

    "description_title": "Що вам сподобалося",
    "images_description_title": "Гарно додати обкладинку, сторiнку з текстом та сторiнку з iлюстрацiєю.",
    ...
    "edit_book_select_age_midschool_title": "середня школа",
    "edit_book_select_age_adult_title": "дорослі",

    "edit_book_description_title": "Що вам сподобалося",
    "edit_book_images_description_title": "Гарно додати обкладинку, сторiнку з текстом та сторiнку з iлюстрацiєю.",
    ...
    "profile_telegram_title": "Telegram",
    "profile_viber_title": "Viber",
    "profile_update_button_title": "Зберегти",
    ...
    "updatingImageProblem_title": "Фотографiї не можна додати через помилку сервера. Максимальний розмір всіх 5 файлів - 100 Мб.",
    ...
    "details_description_title": "Що сподобалося: ",
    "details_owner_title": "Читач: ",
    ...
    "change_language_close_title": "Закрити",
    "log_out_title": "Вийти",
    "profile_about_title": "Про бубук",
    "profile_about_text1": "1. Люди, котрі читають книги, дружать<br>" +
        "2. Книги, котрі читають люди, не залежуються на полицях<br>" +
        "3. Світ стає трішки добрішим<br><br>",
    "profile_about_text2": "<br><br> Ідею придумала моя донька Варя.<br><br>" +
        "До 8 років вона здобула дивовижні якості: любила ділитися і читати.<br><br>" +
        "Обидві ці риси, сміливо думаю, виросли не без моєї допомоги, і пишаюся тим неймовірно.<br><br>" +
        "Отже, в чому ідея Бубуки:<br><br>" +
        "* Варя реєструється в системі, заходить в свій кабінет, додає дані про прочитані книги, якими готова" +
        " ділитися.<br><br>" +
        "* Кіра реєструється в системі, заходить в свій кабінет, додає дані про свої такі  книги.<br><br>" +
        "* Варя шукає книгу, яку хоче прочитати, і - о, диво!  - знаходить її серед книг Кіри.<br><br>" +
        "* Варя пише Кірі: <br> Привіт! Мене зацікавила твоя книга \"Часодії в дії\", подивися, будь" +
        " ласка, може, тобі цікава якась із моїх книг?<br><br>" +
        "* Кіра заходить на сторінку Варі, бачить всі її книги і виявляє, що книга \"Фарбований вовк\" - саме та," +
        " яку вона давно хотіла прочитати.<br><br>" +
        "* Так, - пише Кіра, - давай мінятися!<br><br>" +
        "* Після цього дівчатка обмінюються книгами за допомогою поштових служб або за особистої зустрічі, і світ" +
        " поліпшується)"
}
...
let en = {
    ...
    "menu_books_title": "Find a book",
    "menu_readers_title": "Find a reader",
    "menu_favorite_readers_title": "Friends",
    "favorite_readers_title": "Friends",
    "logo_title": "BooBook",
    "add_reader_to_favorites_title": "Add to friends",
    "remove_reader_from_favorites_title": "Remove from friends",
    ...
    "description_title": "What you liked about it",
    "images_description_title": "Images are recommended to include: cover, one with text, and one with illustration.",
    ...
    "edit_book_description_title": "What you liked about it",
    "edit_book_images_description_title": "Images are recommended to include: cover, one with text, and one with illustration.",
    ...
    "profile_telegram_title": "Telegram",
    "profile_viber_title": "Viber",
    "profile_update_button_title": "Save",
    ...
    "noneFriendYet_title": "None friend added yet. Click on ",
    ...
    "updatingImageProblem_title": "Images cannot be updated because of a server error. Maximum size of all 5 images is 100Mb.",
    ...
    "details_description_title": "Was liked for: ",
    "details_owner_title": "Reader: ",
    ...
    "change_language_close_title": "Close",
    ...
    "profile_about_text2": "<br><br>Idea belonged to my daughter Varya who, being 8-year-old, liked to read and to share. <br><br>" +
        ...
        "* Kira registers in the system, enters her cabinet, adds data for the books she has already read" +
        " and has standing on her bookshelf.<br><br>" +
        ...
        "* Yes, - Kira writes, - let's exchange!<br><br>" +
        "* The girls agree on the way they'd like to share - by mail or by meeting in personal - after that do" +
        " exchange, and the world becomes better)<br><br>"
}
